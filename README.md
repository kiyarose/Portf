...
- GitHub Actions (`cloudflare-pages-preview.yml` and `cloudflare-pages-merge.yml`) run linting, build the bundle, and publish to Cloudflare Pages when enabled. Provide the following repository secrets for automation:
