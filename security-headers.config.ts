...
export const SECURITY_HEADERS = {
  ...
  "Content-Security-Policy":
    ...
    "connect-src 'self' https://send.pageclip.co https://api.iconify.design https://www.googletagmanager.com https://www.google-analytics.com https://challenges.cloudflare.com https://data.sillylittle.tech; " +
